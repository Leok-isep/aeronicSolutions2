...
<head>
    ...
    <meta charset="utf-8" />
    <link rel="stylesheet" href="../assets/presentationTest.css" />
</head>
    ...
    <div class="test">
        ...
        <div class="bloc">
            ...
            <div class="contenu">
                ...
                <p> Déroulement du test : L'utilisateur va placer un doigt sur le capteur qui avec une précision de 0.2 °C, déterminera sa température corporelle. Le résultat s'affichera sur l'écran.</p>
                <div class="image">
                    <img src="../assets/Ressources/Images/température.jpg" alt="©LeDevoir">
                </div>
            </div>
        </div>
        ...
        <div class="bloc">
            ...
            <div class="contenu">
                ...
                <div class="image">
                    <img src="../assets/Ressources/Images/audition.jpg" alt="©futura-sciences">
                </div>
            </div>
        </div>
        ...
        <div class="bloc">
            ...
            <div class="contenu">
                ...
                <div class="image">
                    <img src="../assets/Ressources/Images/oeil.jpg" alt="©FYidoctors">
                </div>
            </div>
        </div>
        ...
        <div class="bloc">
            ...
            <div class="contenu">
                ...
                <p> Déroulement du test : L'utilisateur va placer un doigt dans un conduit qui déterminera sa fréquence cardiaque en battements par minute. Le résultat s'affichera sur l'écran. </p>
                <div class="image">
                    <img src="../assets/Ressources/Images/fréquenceCardiaque.jpg" alt="©freepik">
                </div>
            </div>
        </div>
    </div>
